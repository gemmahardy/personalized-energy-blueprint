...
export const programDays: DayContent[] = [
  // Week 1
  {
    ...
    checklistTasks: [
      { id: "d1-1", label: "Morning hydration: 16oz water upon waking", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d2-1", label: "Morning hydration routine", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d3-1", label: "Hydration check: 64oz water by end of day", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d4-1", label: "Start day with warm lemon water", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d5-1", label: "Morning hydration ritual", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d6-1", label: "Continue hydration habit", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d7-1", label: "Hydration throughout the day", category: "Hydration" },
  ...
  // Week 2 - Days 8-14
  {
    ...
    checklistTasks: [
      { id: "d8-1", label: "Morning hydration + gratitude practice", category: "Mindfulness" },
  ...
  // Each following day follows similar structure with progressive themes
  {
    ...
    checklistTasks: [
      { id: "d9-1", label: "Hydration goal: 80oz today", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d10-1", label: "Morning lemon water ritual", category: "Hydration" },
  ...
  // Days 11-30 abbreviated for length - following same pattern
  {
    ...
    checklistTasks: [
      { id: "d11-1", label: "Consistent hydration", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d12-1", label: "Hydration throughout day", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d13-1", label: "Morning hydration boost", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d14-1", label: "Celebrate with hydration", category: "Hydration" },
  ...
  // Week 3 - Days 15-21
  {
    ...
    checklistTasks: [
      { id: "d15-1", label: "Hydration + electrolyte balance", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d16-1", label: "Strategic hydration timing", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d17-1", label: "Morning ritual perfected", category: "Routine" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d18-1", label: "Hydration excellence", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d19-1", label: "Maintain hydration mastery", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d20-1", label: "Hydration consistency", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d21-1", label: "Celebrate hydration habit", category: "Hydration" },
  ...
  // Week 4 - Days 22-30 (Final Week)
  {
    ...
    checklistTasks: [
      { id: "d22-1", label: "Sustainable hydration routine", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d23-1", label: "Effortless hydration", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d24-1", label: "Hydration mastery continues", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d25-1", label: "Hydration habit perfected", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d26-1", label: "Natural hydration flow", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d27-1", label: "Continue hydration excellence", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d28-1", label: "Hydration excellence", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d29-1", label: "Hydration perfection", category: "Hydration" },
  ...
  },
  {
    ...
    checklistTasks: [
      { id: "d30-1", label: "Final day hydration victory", category: "Hydration" },
